...
def main(args=None):
    ...
    def initial():
        ...
        command = '{"plan":["undock","use the navigation tool to go to the stage","use the speech tool to say something like: hello everyone, my name is adam and I am delighted to welcome you to my presentation. I hope you enjoy the evening and have a great time. lets celebrate with a dance that ive been practicing","use the dance tool to perform a dance"]}'
