...
def main(args=None):
    ...
    def initial():
        ...
        command = '{"plan":["use the navigation tool to go to the stage","use the speech tool to say something like: hello everyone, my name is adam and I am delighted to welcome you to my presentation.", "Use the speech tool to thank everyone for attending and say that youre excited for the bytebot presentation, lets celebrate with a dance that ive been practicing", "use the dance tool to perform a dance", "Use the navigation tool to go to the stage"]}'
